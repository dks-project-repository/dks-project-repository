...
namespace SceneWorld
{
    ...
    public class Avatar : MovableMesh3D
    {
        ...
        protected static void findPath(object o)
        {
            ...
            IndexPair dest = null;
            SortedList<IndexPair, bool> open = new SortedList<IndexPair, bool>(new IndexPair.Comparer()), closed = new SortedList<IndexPair, bool>(new IndexPair.Comparer());
